...
train_csv = pd.read_csv('VisualCheXbert_classes_Val.csv')
...
### AUC_score for every class



def auc_label(classes, test_data, actual, predict):
    ...
    for i in range(len(classes)):
        ...
        print('AUC_score for {} is {}'.format(classes[i], auc))
...
#auc_indiv = auc_label(classes, test_data, actual, predict)
